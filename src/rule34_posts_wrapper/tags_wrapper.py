...
class TagsWrapper(Sequence):
    ...
    def __init__(self, query: str):
        if not is_safe_string(query):
            raise ValueError("Query must consist of letters, numbers, dashes, underscores and apostrophes")
    ...
    def _fetch_tags(self) -> Response:
        ...
        r = requests.get(str(TagsWrapper.generate_autocomplete_url(self._query)),
    ...
    def index(self, value: Tag, start: SupportsIndex = ..., stop: SupportsIndex = ...) -> int:
        """
